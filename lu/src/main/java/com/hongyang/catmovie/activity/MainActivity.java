...
public class MainActivity extends FragmentActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public RelativeLayout fl_movie_scroll;
...
//四个Fragment对象
    ...
    private FrameLayout fl_main_base;
...
//1.初始化所有主界面中的视图对象，包括标题栏和RadioGroup，RadioButton不需要初始化；
        ...
        //自定义的滑块的移动动画控件
        fl_movie_scroll = (RelativeLayout)findViewById(R.id.fl_movie_scroll);//设置总体的隐藏
...
//2.首次进入即创建第一个MovieFragment页面并加载数据
        movieFragment = new MovieFragment(movietitle_scroll_slider,movietitle_scroll_hot
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId) {
            ...
            case R.id.rb_my:
                ...
                if(myFragment == null) {
                    myFragment = new MyFragment(rg_group);
                    FragmentTransaction transaction = fragmentManager.beginTransaction();
