 ...
 */
public class ButtonWish1 extends BaseFragment implements View.OnClickListener {
    ...
    public View initView() {
        ...
        bt_wish_all.setOnClickListener(this);
        bt_wish_now.setOnClickListener(this);
        bt_wish_soon.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case  R.id.bt_wish_all:

                break;
            case  R.id.bt_wish_now:

                break;
            case  R.id.bt_wish_soon:
